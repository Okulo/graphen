...
class swiftbiz_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        $this->opts = array(
            ...
            'delimiter' => '<span class="swiftbiz-breadcrumbs-separator"> >> </span>'
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . __('Home', 'swiftbiz-lite') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'swiftbiz-lite') . ' : ' . $curauth->display_name;

        }

        if (is_tag()) {

            return __('Tag', 'swiftbiz-lite') . ' : ' . single_tag_title('', false);

        }

        if (is_search()) {

            return __('Search', 'swiftbiz-lite');

        }

		if (is_404()) {

            return __('Error 404', 'swiftbiz-lite');
        }
...
$swiftbiz_lite_breadcumb = new swiftbiz_breadcrumb_class();
