...
define('DevelopryGoogleFonts\FONT_OPTIONS', serialize(
  array(
    SLUG . '-body_typeface',
    SLUG . '-body_style',
...
define('DevelopryGoogleFonts\FONT_TAGS', serialize(
  array(
