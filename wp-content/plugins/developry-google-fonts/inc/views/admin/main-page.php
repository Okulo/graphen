  ...
  <div id="poststuff">
    <div id="post-body">
      <div id="post-body-content">
        <div class="wrap-card-container developry-google-fonts">
          <div class="wrap card">
            <h1><?php echo NAME; ?></h1>
          ...
          <div class="wrap card">
            ...
            <form id="dgf-from" name="dgf-from" method="post" action="">
              <?php $message = update_admin_fonts(); ?>
              <input type="hidden" name="dgf-submitted" value="1" />
              <table class="dgf-form-table">
                <tbody>
                  <tr>
                    <th scope="row">
