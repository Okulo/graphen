      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            $sktlink = "http://www.sketchthemes.com/themes/swiftbiz-business-wordpress-theme/";
            $sktratelink = "http://wordpress.org/support/view/theme-reviews/swiftbiz-lite";
            $skttest_drive = "http://trial.sketchthemes.com/wp-signup.php";
            
            echo '  <div class="donate-info">
          <strong>'. __( "To Activate All Features, Please Upgrade to Pro version!", "swiftbiz-lite" ) .'</strong><br/>
          <a title="'. __( "Upgrade to Pro", "swiftbiz-lite" ) .'" href="'. esc_url($sktlink) .'" target="_blank" class="upgrade">'. __( "Upgrade to Pro", "swiftbiz-lite" ) .'</a> <a title="'. __( 'Setup Instructions', 'swiftbiz-lite' ) .'" href="'. get_template_directory_uri().'/Installation_Instructions.txt' .'" target="_blank" class="donate">'. __( 'Setup Instructions', 'swiftbiz-lite' ) .'</a>
          <a title="'. __( 'Rate Swiftbiz Lite', 'swiftbiz-lite' ) .'" href="'. esc_url($sktratelink) .'" target="_blank" class="review">'. __( 'Rate Swiftbiz Lite', 'swiftbiz-lite' ) .'</a>
          <a title="'. __( 'Test Drive', 'swiftbiz-lite' ) .'" href="'. esc_url($skttest_drive) .'" target="_blank" class="review">'. __( 'Theme Test Drive', 'swiftbiz-lite' ) .'</a>
        </div>
            ...
            <div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-logo">' . apply_filters( 'ot_header_logo_link', '<a href="http://swiftbiz_themes.com" target="_blank">OptionTree</a>', $page['id'] ) . '</li>';
                  
                  echo '<li id="option-tree-version"><span>Version ' . SWIFTBIZ_THEME_VERSION . '</span></li>';
