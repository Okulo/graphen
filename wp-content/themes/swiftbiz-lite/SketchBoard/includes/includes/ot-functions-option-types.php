        ...
        if ( in_array( 'background-image', $ot_recognized_background_fields ) ) {
          ...
          if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
            ...
            echo '<div class="option-tree-ui-media-wrap" id="' . esc_attr( $field_id ) . '_media">';
              ...
              echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . __( 'Remove Media', 'option-tree' ) . '"><span class="icon ot-icon-minus-sign"></span>' . __( 'Remove Media', 'option-tree' ) . '</a>';
...
if ( ! function_exists( 'ot_type_date_picker' ) ) {
  ...
  function ot_type_date_picker( $args = array() ) {
    ...
    /* filter date format */
    $date_format = apply_filters( 'ot_type_date_picker_date_format', 'MM d, yy', $field_id );
...
if ( ! function_exists( 'ot_type_numeric_slider' ) ) {
  ...
  function ot_type_numeric_slider( $args = array() ) {
	...
	// FIXED NUMERIC_SLIDER ELEMENT STANDARD VALUE ISSUE =================================
	$field_value = (isset($field_value) && $field_value !="") ? $field_value : $field_std;
	//====================================================================================
  ...
  function ot_type_on_off( $args = array() ) {
    ...
    echo '<div class="format-setting type-radio ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
		...
		// FIXED ON-OFF ELEMENT STANDARD VALUE ISSUE =========================================
		  $field_value = (isset($field_value) && $field_value !="") ? $field_value : $field_std;
		//====================================================================================
...
if ( ! function_exists( 'ot_type_radio' ) ) {
  ...
  function ot_type_radio( $args = array() ) {
	...
	// FIXED OT_TYPE_RADIO ELEMENT STANDARD VALUE ISSUE =================================
	$field_value = (isset($field_value) && $field_value !="") ? $field_value : $field_std;
	//====================================================================================
...
if ( ! function_exists( 'ot_type_radio_image' ) ) {
  ...
  function ot_type_radio_image( $args = array() ) {
	...
	// FIXED OT_TYPE_RADIO_IMAGE ELEMENT STANDARD VALUE ISSUE ============================
	$field_value = (isset($field_value) && $field_value !="") ? $field_value : $field_std;
	//====================================================================================
 ...
 * @since     swiftbiz
 */
if ( ! function_exists( 'ot_type_info' ) ) {
  
  function ot_type_info( $args = array() ) {
    
    echo '<div class="format-setting">';
      
      echo '<div class="format-setting-inner">';
      
        echo '<p>'.$args['field_desc'].'</p>';
