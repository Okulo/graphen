...
Additional information with step-by-step setup, usage, demos, and more video & media help can be found on the Developry [**Google Fonts Loader**](https://developry.com/google-fonts-loader) website.

### Google Fonts Loader Pro
...
2. Search for **Google Fonts Loader**.
3. Install and activate the **Google Fonts Loader** plugin.
...
2. Visit **Plugins**.
3. Activate the **Google Fonts Loader** plugin.
4. You will be either redirected to the plugin main page or need click on the plugin settings link.
