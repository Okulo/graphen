(function ($) {
  ...
  plugin.add_toolbar_message = function () {
    $("<div/>")
      .attr("class", "developry-google-fonts-custom-toolbar-message")
      .html(
        `<span class="developry-hint" title="Click on editor element to see the font fiamly/weight/style; Double click to select the whole element for update.">
  ...
  plugin.editor = function () {
    ...
    tinymce.create("tinymce.plugins.DGF", {
      init: function (editor, url) {
        ...
        editor.addButton("developry-google-fonts-typeface-button", {
          type: "listbox",
          name: "font-family",
        ...
        editor.addButton("developry-google-fonts-style-button", {
          type: "listbox",
          name: "font-styles",
    ...
    tinymce.PluginManager.add("developry-google-fonts", tinymce.plugins.DGF);
  };
