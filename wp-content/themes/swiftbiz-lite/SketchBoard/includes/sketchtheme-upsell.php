...
function swiftbiz_sell_style() {
    // Set template directory uri
    $directory_uri = get_template_directory_uri();
    wp_enqueue_style( 'upsell_style', get_template_directory_uri() . '/SketchBoard/includes/assets/css/upsell.css' );
}
add_action( 'admin_init', 'swiftbiz_sell_style' );

// Add upsell page to the menu.
function swiftbiz_add_upsell() {
    $page = add_theme_page( __('Sketch Themes', 'swiftbiz-lite'), __('Sketch Themes', 'swiftbiz-lite'), 'administrator', 'sketch-themes', 'swiftbiz_display_upsell' );
    add_action( 'admin_print_styles-' . $page, 'swiftbiz_sell_style' );
}
add_action( 'admin_menu', 'swiftbiz_add_upsell',12 );

// Define markup for the upsell page.
function swiftbiz_display_upsell() {
        ...
        <div id="upsell_header" class="span12">
            <h2>
                <a href="http://www.sketchthemes.com/" target="_blank">
                    <img alt="<?php _e("SketchThemes","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/sketch-logo.png"/>
                </a>
            </h2>
        </div>
    </div>
        ...
        <div id="Avis" class="row-fluid">
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/avis-consulting-business-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Avis Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Avis_iMac.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/avis-consulting-business-wordpress-theme/" target="_blank"><h4><?php _e('Avis - Business Consulting WordPress Theme','swiftbiz-lite');?></h4></a>
                    ...
                    <a class="buy  btn btn-info" href="http://www.sketchthemes.com/preview/avis/" target="_blank"><?php _e( 'View Demo', 'swiftbiz-lite' ); ?></a>
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/avis-consulting-business-wordpress-theme/" target="_blank"><?php _e( 'Buy Avis Pro', 'swiftbiz-lite' ); ?></a>
    ...
    <!-- -------------- Connexions Pro ------------------- -->
        ...
        <div id="Connexions" class="row-fluid">
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/connexions-corporate-portfolio-onepage-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Connexion Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Connexions_iMac.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/connexions-corporate-portfolio-onepage-wordpress-theme/" target="_blank"><h4><?php _e('Connexions- Corporate Business WordPress Theme','swiftbiz-lite');?></h4></a>

                    <div class="theme-description">
                        <p><?php _e("Connexion is a simple, minimal, responsive, easy to use, one click install, beautiful and Elegent WordPress Theme with Easy Custom Admin Options Created by SketchTheme.com. Using Connexion theme options any one can easily customize this theme according to their need. You can use your own Logo, logo alt text, custom favicon, you can add social links, rss feed to homepage, you can use own copyright text, you can also insert analytics code etc. And all this information can be entered using Connexion Theme Options Panel. You have to just set the content from the Connexion Themes Options Panel and it'll be up ready to use.",'swiftbiz-lite'); ?></p>
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/connexions-corporate-portfolio-onepage-wordpress-theme/" target="_blank"><?php _e( 'Buy Connexions Pro', 'swiftbiz-lite' ); ?></a>
        ...
        <div id="LeadSurf" class="row-fluid">
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/leadsurf-lead-capture-landing-page-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("LeadSurf Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/LeadSurf_iMac.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/leadsurf-lead-capture-landing-page-wordpress-theme/" target="_blank"><h4><?php _e('LeadSurf - App Launch WordPress Theme','swiftbiz-lite');?></h4></a>
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/leadsurf-lead-capture-landing-page-wordpress-theme/" target="_blank"><?php _e( 'Buy LeadSurf Pro', 'swiftbiz-lite' ); ?></a>
        ...
        <div id="InstaAppointment" class="row-fluid">
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/instaappointment-responsive-appointment-booking-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("InstaAppointment Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Insta-Appointment_iMac.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/instaappointment-responsive-appointment-booking-wordpress-theme/" target="_blank"><h4><?php _e('InstaAppointment - Responsive Appointment Booking WordPress Theme','swiftbiz-lite');?></h4></a>
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/instaappointment-responsive-appointment-booking-wordpress-theme/" target="_blank"><?php _e( 'Buy InstaAppointment Pro', 'swiftbiz-lite' ); ?></a>
        ...
        <div id="Eptima" class="row-fluid">
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/eptima-corporate-responsive-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Eptima Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Eptima_iMac.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/eptima-corporate-responsive-wordpress-theme/" target="_blank"><h4><?php _e('Eptima - Corporate Responsive WordPress Theme','swiftbiz-lite');?></h4></a>
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/eptima-corporate-responsive-wordpress-theme/" target="_blank"><?php _e( 'Buy Eptima Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/rational-impressive-one-pager-responsive-business-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Rational Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Rational.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/rational-impressive-one-pager-responsive-business-wordpress-theme/" target="_blank"><h4><?php _e('Rational - Impressive One Pager Responsive Business WordPress Theme','swiftbiz-lite');?></h4></a>

                    <div class="theme-description">
                        <p><?php _e("Every business requires an approach that shows the logic behind floating the trade and the exact objective with which the venture is initiated.Adding a rational approach to every business in the first place, the Rational - One Pager Responsive Business WordPress Theme certainly promises to better users experience.",'swiftbiz-lite'); ?></p>
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/rational-impressive-one-pager-responsive-business-wordpress-theme/" target="_blank"><?php _e( 'Buy Rational Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/incart-responsive-woocommerce-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Incart Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Incart.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/incart-responsive-woocommerce-wordpress-theme/" target="_blank"><h4><?php _e('InCart - Responsive WooCommerce WordPress Theme','swiftbiz-lite');?></h4></a>
                    ...
                    <a class="buy  btn btn-info" href="http://sketchthemes.com/samples/incart-responsive-woocommerce-demo/" target="_blank"><?php _e( 'View Demo', 'swiftbiz-lite' ); ?></a>
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/incart-responsive-woocommerce-wordpress-theme/" target="_blank"><?php _e( 'Buy Incart Pro', 'swiftbiz-lite' ); ?></a>
		...
		<div class="theme-container">
			<div class="theme-image span3">
				<a href="http://www.sketchthemes.com/themes/convac-responsive-multi-author-blogging-theme/?ref=advlite" target="_blank">
					<img alt="<?php _e("Convac Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/convac.png" width="300px"/>
				</a>
			</div>
			<div class="theme-info span9">
				<a class="theme-name" href="http://www.sketchthemes.com/themes/convac-responsive-multi-author-blogging-theme/?ref=advlite" target="_blank"><h4><?php _e('Convac - Responsive Multi Author Blogging Theme','swiftbiz-lite');?></h4></a>
				...
				<a class="free btn btn-success" href="http://wordpress.org/themes/swiftbiz-lite/?ref=advlite" target="_blank"><?php _e( 'Try Convac Free', 'swiftbiz-lite' ); ?></a>
				...
				<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=67&product_id=67&paysys_id=twocheckout_r/?ref=advlite" target="_blank"><?php _e( 'Buy Convac Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/foodeez-multi-cuisine-restaurant-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Foodeez Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Foodeez-Theme.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/" target="_blank"><h4><?php _e('Foodeez - Multi Cuisine Restaurant WordPress Theme','swiftbiz-lite');?></h4></a>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=63&product_id=63&paysys_id=twocheckout_r" target="_blank"><?php _e( 'Buy Foodeez Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/advertica-the-uber-clean-multipurpose-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Advertica Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Advertica_screen_420px.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/" target="_blank"><h4><?php _e('Advertica - Creative MultiPurpose WordPress Theme','swiftbiz-lite');?></h4></a>
					...
					<a class="free btn btn-success" href="http://wordpress.org/themes/swiftbiz-lite" target="_blank"><?php _e( 'Try Advertica Free', 'swiftbiz-lite' ); ?></a>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=58&product_id=58&paysys_id=twocheckout_r" target="_blank"><?php _e( 'Buy Advertica Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/invert-responsive-multipurpose-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Invert Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Invert-mac-300px.png"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/invert-responsive-multipurpose-wordpress-theme/" target="_blank"><h4><?php _e('Invert - Responsive MultiPurpose WordPress Theme','swiftbiz-lite');?></h4></a>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=44&product_id=44&paysys_id=twocheckout_r" target="_blank"><?php _e( 'Buy Invert Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/biznez-multi-purpose-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("BizNez Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/biznez-career-counseling-demo.png"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/biznez-multi-purpose-wordpress-theme/" target="_blank"><h4><?php _e('Biznez - Multi Purpose Wordpress Theme','swiftbiz-lite');?></h4></a>

                    <div class="theme-description">
                        <p><?php _e('BizNez is a powerful Responsive Multipurpose WordPress Theme with clean and crispy design. BizNez is modern and flexible enough. It allows you to create your website around any niche without the need of any complicated HTML code knowledge. Be it a Blog, Business, Portfolio, Corporate, Agency, an online store or any other kind of website BizNez will be a good pick for you. With our advanced admin panel, tons of customizations are possible and that&#39;ll help you redefine your website&#39;s brand value. You can also change site layout with only a single click. Also, this theme comes with retina ready feature. You can see great details on any devices screen. Woo Commerce and RTL languages are also supported with our BizNez theme.','swiftbiz-lite'); ?></p>

                    </div>

					<a class="free btn btn-success" href="http://wordpress.org/themes/biznez-lite" target="_blank"><?php _e( 'Try Biznez Free', 'swiftbiz-lite' ); ?></a>
                    <a class="buy  btn btn-info" href="http://demo.sketchthemes.com/preview-images/biznez/" target="_blank"><?php _e( 'View Demo', 'swiftbiz-lite' ); ?></a>
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=19&product_id=19&hide_paysys=paypal_r" target="_blank"><?php _e( 'Buy Biznez Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/analytical-full-width-responsive-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Analytical Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Analytical_Interior_Demo.png"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/analytical-full-width-responsive-wordpress-theme/" target="_blank"><h4><?php _e('Analytical Full Width Responsive Wordpress Theme','swiftbiz-lite');?></h4></a>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=17&product_id=17&hide_paysys=paypal_r" target="_blank"><?php _e( 'Buy Analytical Pro', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/bizstudio-full-width-responsive-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("BizStudio Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/bizstudio-default-demo.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/bizstudio-full-width-responsive-wordpress-theme/" target="_blank"><h4><?php _e('BizStudio Full Width Responsive Wordpress Theme','swiftbiz-lite');?></h4></a>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=14&product_id=14&hide_paysys=paypal_r" target="_blank"><?php _e( 'Buy BizStudio Pro', 'swiftbiz-lite' ); ?></a>
                </div>
            </div>
        </div>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/irex-full-width-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Irex Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/irex-mac-420px.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/irex-full-width-wordpress-theme/" target="_blank"><h4><?php _e('Irex Full Width Portfolio Wordpress Theme','swiftbiz-lite');?></h4></a>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=15&product_id=15&hide_paysys=paypal_r" target="_blank"><?php _e( 'Buy Irex Pro', 'swiftbiz-lite' ); ?></a>
                </div>
            </div>
        </div>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/sketchmini-free-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Sketchmini Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/sketchmini-mac-420px.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/sketchmini-free-wordpress-theme/" target="_blank"><h4><?php _e('SketchMini Free Responsive WordPress Theme','swiftbiz-lite');?></h4></a>
					...
					<a class="free btn btn-success" href="http://www.sketchthemes.com/themes/sketchmini-free-wordpress-theme/#FreeDownloadButton" target="_blank"><?php _e( 'Try Sketchmini Lite', 'swiftbiz-lite' ); ?></a>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/fullscreen-onepager-responsive-wordpress-theme/?ref=litetheme" target="_blank">
                        <img alt="<?php _e("Fullscreen Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/fullscreen-mac-420px.png" width="300px"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/fullscreen-onepager-responsive-wordpress-theme/?ref=litetheme" target="_blank"><h4><?php _e('FullScreen - OnePager Responsive WordPress Theme','swiftbiz-lite');?></h4></a>

                    <div class="theme-description">
                        <p><?php _e('FullScreen is clean, multipurpose and elegant WordPress theme with fully responsive layout. Theme is suited for all photographers, creative, business and portfolio websites. Theme includes lots of features like full-screen slider, modular homepage, layout shortcodes and more. With our advanced admin panel, tons of customizations are possible and that will help you redefine your website brand value.','swiftbiz-lite');?></p>
                    </div>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=27&product_id=27&hide_paysys=paypal_r/?ref=litetheme" target="_blank"><?php _e( 'Buy FullScreen Pro', 'swiftbiz-lite' ); ?></a>
                </div>
            </div>
        </div>
            ...
            <div class="theme-container">
                <div class="theme-image span3">
                    <a href="http://www.sketchthemes.com/themes/timeliner-minimal-ultra-responsive-wordpress-theme/" target="_blank">
                        <img alt="<?php _e("Timeliner Theme","swiftbiz-lite"); ?>" src="<?php echo $directory_uri; ?>/SketchBoard/includes/images/Timeliner_Modeling_Demo.png"/>
                    </a>
                </div>
                <div class="theme-info span9">
                    <a class="theme-name" href="http://www.sketchthemes.com/themes/timeliner-minimal-ultra-responsive-wordpress-theme/" target="_blank"><h4><?php _e('Timeliner - Minimal Ultra Responsive WordPress Theme','swiftbiz-lite');?></h4></a>

                    <div class="theme-description">
                        <p><?php _e('Timeliner is a premier timeline theme for WordPress. Timeliner is a minimal, clean, modern and highly customizable theme. It allows you to create their website around any niche without the need of any complicated HTML code knowledge. Be it a Blog, Portfolio, Corporate, Agency, any other kind of website Timeliner will be a good pick for you. With our advanced admin panel, tons of customizations are possible and that will help you redefine your website&#39;s brand value. Also, this theme comes with retina ready feature. You can see great details on any devices screen.','swiftbiz-lite');?></p>
                    </div>
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=30&product_id=30&hide_paysys=paypal_r" target="_blank"><?php _e( 'Buy Timeliner Pro', 'swiftbiz-lite' ); ?></a>
